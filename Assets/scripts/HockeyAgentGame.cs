...
public class HockeyAgentGame : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        float forceMagnitude = direction * Random.Range(1f, 10f); // You can adjust this value as needed
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        // Move sideways
        float moveActionSW = continuousActions[1] * 0.001f; // Assuming sideways movement is at index 0
        Vector3 moveDirectionSW = transform.right * moveActionSW * moveSpeed;

        // Move forward or backward
        float moveActionFW = continuousActions[0] * 0.001f; // Assuming forward/backward movement is at index 1
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.transform.CompareTag("Puck"))
        {
            ...
            if (puckRb != null)
            {
                puckRb.velocity += agentMovement * 0.01f;
            }
        }
    }
